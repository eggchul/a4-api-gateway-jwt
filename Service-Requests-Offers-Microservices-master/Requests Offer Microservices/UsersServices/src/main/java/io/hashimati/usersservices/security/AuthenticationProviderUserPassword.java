...
public class AuthenticationProviderUserPassword implements AuthenticationProvider  {
    ...
    private StrongPasswordEncryptor strongPasswordEncryptor ;
        ...
        // AuthenticationProvider is an interface so need to override the authenticate function
    @Override
    public Publisher<AuthenticationResponse> authenticate(AuthenticationRequest authenticationRequest) {
        ...
        // flowable used for sync ?
        // for JDBC use, file reading and analysis, supports 10k+ element, network IO
